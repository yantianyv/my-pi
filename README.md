...
| 行2 `↑212k ↓79.7k 12.3/s` | 本会话已消耗的输入、输出 token + 输出 token 生成速率（tok/s，最近 3 轮 turn 平均：输出 token / turn 实际耗时，不足 3 轮时有几轮算几轮） |
